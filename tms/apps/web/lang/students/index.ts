import { ILangStudentChangePassword, LangStudentChangePassword } from "./changPassword";
...
export type TLangStudentModuleType = (module: typeof LangStudent) => LangStudentModule;
