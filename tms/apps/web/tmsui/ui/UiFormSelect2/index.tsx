                        ...
                        <Controller
                            ...
                            render={({ field }) => {
                                ...
                                if (isMulti) {
                                    ...
                                    const fieldArray: string[] = Array.isArray(field.value)
                                        ? field.value
                                        : field.value
                                            ? [field.value]
                                            : [];
                                ...
                                return (
                                    <Select<IOption, boolean>
                                        ...
                                        onChange={(selected) =>
                                            field.onChange(
                                                isMulti
                                                    ? (selected as MultiValue<IOption> ?? []).map((o: IOption) => o.value as string)
                                                    : (selected as IOption)?.value as string ?? null
                                            )
                                        }
                                        onBlur={field.onBlur}
                                        classNames={{
