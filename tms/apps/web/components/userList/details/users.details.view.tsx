          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-900">{editData?.email}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {view.department}
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">{editData?.role?.name}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {view.status}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-900">{editData?.employeeId}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {view.startDate}
                </label>
                <p className="text-sm text-gray-900">{editData?.joinDate}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {view.tag}
