...
import { ForgotPasswordFormSchema, TForgotPasswordViewSchema } from "./forgot-password.form.type";

export default function ForgotPasswordFormView(props: TForgotPasswordViewSchema) {
    ...
    return (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900">パスワードを忘れた場合</h2>
                <p className="mt-2 text-sm text-gray-600">メールアドレスを入力してリセット手順を受け取る</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <UiFormInput<ForgotPasswordFormSchema>
                    type="email"
                    name="email"
