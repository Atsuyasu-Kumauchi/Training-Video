...
import { trainings } from "./myTraining.list.type";
...
export default function MyTrainingListView() {
    ...
    const openVideos = (id: number, title: string) => {
        router.push(`/student/training-videos/?training=${id}&title=${encodeURIComponent(title)}`);
    };
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-xs text-gray-500 mt-2">
                                <span>
                                    ...
                                    {t.completedVideos}/{t.totalVideos} 動画
                                </span>
