...
export const TrainingView = (training: ITrainingsDto) => {
  ...
  const { trainingList: userLang } = useLang();
  return (
    <div className="flex items-center space-x-2">
      <Button
      ...
      <UiBasicModal
        modalRef={modalRef}
        title={userLang.view.trainingDetail + " - " + training?.name} //Training Details
        body={
          <TrainingDetailsComponent editData={training} modalRef={modalRef} />
        }
      />
    </div>
  );
...
export const TrainingEdit = (training: ITrainingsDto) => {
  ...
  return (
    <>
      ...
      <UiBasicModal
        modalRef={modalRef}
        title={userLang.form.editTraining + " - " + training?.name}
        body={
